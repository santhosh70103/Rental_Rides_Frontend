  ...
  return (
    <aside className="w-1/4 bg-white p-4 shadow rounded">
      ...
      <div className="mb-4">
        ...
        <ul>
          <li><input type="checkbox" id="1-2" /> <label htmlFor="1-2">4 Seats</label></li>
          <li><input type="checkbox" id="3-5" /> <label htmlFor="3-5">5 Seats</label></li>
      ...
      <div className="mb-4">
        ...
        <ul>
          <li><input type="checkbox" id="1-2-bags" /> <label htmlFor="1-2-bags"></label></li>
